...
const bootstrap = read('adminWww/assets/bootstrap-COulQZax-v72.js');
const adaptersBuilt = read('adminWww/assets/Adapters-B5_jQ7DE-v72.js');
const instancesBuilt = read('adminWww/assets/Instances-YdaGnS5a-v72.js');
