...
must(pkg.version === '7.10.8' && io.version === '7.10.8' && io.common.version === '7.10.8' && info.version === '7.10.8', 'version drift');
...
// 7.10.4 placement acceptance remains mandatory in 7.10.8: System Settings only.
