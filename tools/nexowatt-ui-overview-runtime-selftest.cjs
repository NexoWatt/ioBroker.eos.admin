...
for(const marker of ['eos-ems-overview.css?v=100','eos-ems-overview.js?v=100','nexowatt-stable-v100.js?v=100','eos-release-watch.js?v=100'])if(!index.includes(marker))fail(`index marker missing: ${marker}`);
