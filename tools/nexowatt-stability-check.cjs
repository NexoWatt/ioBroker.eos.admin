...
if (!/^7\.9\.\d+$/.test(version)) fail(`unexpected version ${version}`);
...
for (const marker of [
  ...
  `eos-manual-write-policy.js?v=${shellNo}`,
  `eos-policy-client.js?v=${shellNo}`,
  `nexowatt-native-shell.js?v=${shellNo}`,
  `eos-native-security.js?v=${shellNo}`,
  `eos-role-ui.js?v=${shellNo}`,
  `eos-assistant.js?v=${shellNo}`,
  `nexowatt-native-shell.css?v=${shellNo}`,
...
const scripts = ['eos-policy-client.js','nexowatt-native-shell.js','eos-native-security.js','eos-role-ui.js','eos-assistant.js'];
...
for (const rel of ['js/eos-policy-client.js','js/nexowatt-native-shell.js','js/eos-native-security.js','js/eos-role-ui.js','js/eos-assistant.js','js/eos-manual-write-policy.js','css/nexowatt-native-shell.css']) {
