...
for (const marker of [
  'v97-native-overview-ems-live-reserve-filter', 'App.expertMode', "setItem('App.expertMode', 'false')",
...
for (const marker of [
  ...
  'v97 compact normal-login first activation', "defaultTab = () => 'tab-intro'", 'isOfficialReserveTab', 'isCustomerBackupTab',
