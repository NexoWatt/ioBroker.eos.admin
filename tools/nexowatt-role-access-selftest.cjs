...
for (const marker of [
  'v7100-native-overview-ems-live-reserve-filter', 'App.expertMode', "setItem('App.expertMode', 'false')",
...
for (const marker of [
  ...
  'v7100 normal-login first activation', "defaultTab = () => 'tab-intro'", 'isOfficialReserveTab', 'isCustomerBackupTab',
