...
try {
  ...
  fs.writeFileSync(path.join(temp, 'NEXOWATT_EOS_BUILD_INFO.json'), JSON.stringify({ runtimeEntry: 'v82', shellCacheVersion: 99 }));
  ...
  assert.strictEqual(result.activeShell, 99);
