...
if (pkg.scripts['check:eos-stable-v99'] !== 'node tools/nexowatt-stable-v99-selftest.cjs') fail('stable v99 selftest script is missing or incorrect');
...
for (const file of [
  ...
  'README_STABILITY_V7.9.99.md',
  'RELEASE_NOTES_V7.9.99.md',
  'PUBLISH_STABLE_V7.9.99.md',
  'INSTALL_TEST_V7.9.99.md',
  'RELEASE_ACCEPTANCE_V7.9.99.md',
  'MERGE_UPDATE.ps1',
  'MERGE_UPDATE.cmd',
  ...
  'tools/nexowatt-stable-v99-selftest.cjs',
  ...
  'adminWww/static/js/nexowatt-stable-v99.js',
...
if (!index.includes(`nexowatt-stable-v99.js?v=${shellTag}`)) fail('stable v99 cache key mismatch');
...
if (!roleBootstrap.includes('installIntegratedFirstLogin') || !roleBootstrap.includes('v99 normal-login first activation')) fail('compact integrated first-login is incomplete');
